        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative">
                <img
                    src={headerImage}
                    alt="Header"
                    className="w-full max-h-40 object-cover brightness-75"
                />
                <button
                    onClick={() => window.location.href = '/login'}
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-yellow-400 to-yellow-600 text-white rounded-full font-semibold px-8 py-4 hover:scale-110 hover:from-yellow-600 hover:to-yellow-800 transition duration-300 shadow-lg">
                    <div className="flex items-center justify-center gap-2">
                        <span className="text-lg"> Rejoignez-nous</span>
                        <span className="text-xs italic">Connexion rapide</span>
                    </div>
                </button>
            </div>
